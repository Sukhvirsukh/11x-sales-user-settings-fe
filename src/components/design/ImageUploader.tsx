...
export default function ImageUploader({
    ...
    return (
        <div className={cn("flex w-full flex-col gap-2", className)}>
            ...
            <div
                className={cn(
                    "relative flex h-[34px] items-center overflow-hidden rounded-xl border border-control-border-subtle px-3.5 transition-all focus-within:border-field-border focus-within:ring-2 focus-within:ring-focus-ring/20",
                    "bg-surface-raised focus-within:bg-surface-raised",
                    variant === "light"
                        ? "border-section-border bg-field-subtle-background focus-within:border-section-border focus-within:bg-field-subtle-background"
                        : "",
