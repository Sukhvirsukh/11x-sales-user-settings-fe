...
export default function LeadCollection() {
    const leadStatus = useVisibilityStore((s) => s.fields.leadStatus);
    const leadTitle = useVisibilityStore((s) => s.fields.leadTitle);
    const leadSubtitle = useVisibilityStore((s) => s.fields.leadSubtitle);
    const sendButtonLabel = useVisibilityStore((s) => s.fields.sendButtonLabel);
    const emailPlaceholder = useVisibilityStore((s) => s.fields.emailPlaceholder);
    const marketingConsent = useVisibilityStore((s) => s.fields.marketingConsent);
    const consentCheckboxDefault = useVisibilityStore((s) => s.fields.consentCheckboxDefault);
    const marketingConsentText = useVisibilityStore((s) => s.fields.marketingConsentText);
    ...
    return (
        <CustomFormGroup gap="lg">
            ...
            <CustomFormGroup gap="md">
                <CustomLabel htmlFor="consent-checkbox-default">Marketing consent checkbox default</CustomLabel>
                <RadioGroup
                    value={consentCheckboxDefault}
                    onValueChange={(value) => {
