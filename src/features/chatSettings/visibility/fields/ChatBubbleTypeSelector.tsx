            ...
            >
                {BUBBLE_OPTIONS.map((option) => (
                    <label
                        key={option.value}
                        className={cn(
                            "flex w-full flex-col rounded-lg border transition-colors cursor-pointer",
                            "hover:bg-muted/50 has-[:focus-visible]:border-ring has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-ring/50",
                            value === option.value ? "border-primary bg-primary/10" : "border-border",
                            disabled && "opacity-50 cursor-not-allowed"
                        )}
                    >
                        {/* Upper part: Radio + Label */}
                        <div className={cn(
                            ...
                            <RadioGroupItem
                                ...
                                className={cn(
                                    ...
                                    value === option.value && "border-primary-foreground text-primary-foreground"
                                )}
                            />
