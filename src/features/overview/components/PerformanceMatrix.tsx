    ...
    return (
        <>
            ...
            <CustomTabs
                ...
                triggerClassName="h-auto min-w-0 rounded-none border-0 !bg-transparent px-0 pb-2 text-sm font-normal text-content-muted shadow-none hover:!bg-transparent focus-visible:!border-transparent focus-visible:!ring-0 focus-visible:!outline-none data-active:!border-x-0 data-active:!border-t-0 data-active:!border-b-2 data-active:!border-content-muted data-active:!bg-transparent data-active:!font-bold data-active:!shadow-none after:hidden lg:text-base"
